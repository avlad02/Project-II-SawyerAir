...
namespace SawyerAir.Controllers
{
    public class CardsController : Controller
    {
        ...
        {
            var flightsContext = _context.Cards.Include(c => c.Client);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(Guid id, [Bind("CardId,ClientId,ExpirationDate,Number,CVC")] Card card)
        {
            if (id != card.CardId)
            {
                return NotFound();
